...
\begin{remark}~
    \begin{itemize}
        \item Variables defined inside a function are not stored at a fixed address.
        \item The address of an object defined outside of any function is a constant expression.
    \end{itemize}
\end{remark}
...
\begin{definition}[pointer, const, type alias]~
    \begin{verbatim}
...
\subsubsection{The Auto Type Specifier}
\begin{definition}[auto]
    A variable that uses \verb|auto| must have an initializer.
...
\begin{example}[compound types, const, and auto]~
    \begin{verbatim}
int i = 1;
const int ci = i;
...
\section{Defining Out Own Data Structures}
\begin{verbatim}
struct Node
{
    int val;
