...
\title{Analysis}
\author{PENG}
\date{Created: 20260801, Version: 20260916}
...
Mathematics treats its objects abstractly, caring only about what \textbf{properties} the objects have \cite{TAO_2022_ANALYSIS_I}.

\section{Natural Number system}
\subsection{The Peano Axioms}
\begin{axiom}
    \label{axiom:peano-axioms-1}
    0 is a natural number.
\end{axiom}

\begin{axiom}
    \label{axiom:peano-axioms-2}
    If $n$ is a natural number, then $n\pp$ is also a natural number.
\end{axiom}

\begin{definition}
    \label{def:nat}
    $1 := 0\pp$, $2 := 1\pp$, $3 := 2\pp$, $\dots$
\end{definition}
...
\begin{proof}
    By Axiom \ref{axiom:peano-axioms-1}, 0 is a natural number.

    By Axiom \ref{axiom:peano-axioms-2}, $0\pp = 1$ is a natural number.

    By Axiom \ref{axiom:peano-axioms-2}, $1\pp = 2$ is a natural number.

    By Axiom \ref{axiom:peano-axioms-2}, $2\pp = 3$ is a natural number.
\end{proof}

\begin{axiom}
    \label{axiom:peano-axioms-3}
    $n\pp \neq 0$
\end{axiom}
...
\begin{proof}
    By definition \ref{def:nat}, $3\pp = 4$.

    By Proposition \ref{prop:3-is-nat}, 3 is a natural number.

    By Axiom \ref{axiom:peano-axioms-3}, $3\pp = 4 \neq 0$.
\end{proof}

\begin{axiom}
    \label{axiom:peano-axioms-4}
    $n \neq m \Rightarrow n\pp \neq m\pp$ or $n\pp = m\pp \Rightarrow n = m$
\end{axiom}

\begin{axiom}[principle of mathematical induction]
    \label{axiom:peano-axioms-5}
